    ...
    <div className="card group flex flex-col animate-fade-in hover:shadow-md transition-shadow duration-200">
      ...
      <div className="relative overflow-hidden h-44">
        <img
          ...
          loading="lazy"
        />
        <span className="absolute top-3 left-3 bg-white/90 text-brand-700 text-xs font-medium px-2.5 py-1 rounded-full">
          {item.category}
        </span>
      </div>
      ...
      <div className="flex flex-col flex-1 p-4 gap-2">
        <div className="flex justify-between items-start gap-2">
          <h3 className="font-display text-ink font-semibold text-base leading-tight">
            {item.name}
          </h3>
